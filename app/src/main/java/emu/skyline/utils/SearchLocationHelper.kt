...
interface SearchLocationHelper {
    companion object {
        ...
        fun getSearchLocations(context : Context) : List<Uri> {
            ...
            var urisArray = mutableListOf<Uri>();
        ...
        /**
        * Adds the given search location to the application settings
        * @param uri The uri of the search location to add
        ...
        * @param uri The uri of the search location to delete
        * @return The exit status of the installation process
        */
